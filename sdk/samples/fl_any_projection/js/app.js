require([
  ...
  function buildMap(b) {
    ...
    // USA
    var layer = new FeatureLayer("http://sampleserver6.arcgisonline.com/arcgis/rest/services/Census/MapServer/3");
    // other layers to use...world regions:
    // var layer = new FeatureLayer("http://sampleserver6.arcgisonline.com/arcgis/rest/services/WorldTimeZones/MapServer/2");
    // countries:
    // var layer = new FeatureLayer("http://wwtw.esriuk.com/ArcGIS/rest/services/CG/WorldCountries/MapServer/0");
